  ...
  <div align="center" style="padding:50px">
    <table>
        <tr>
            ...
            <th class="appointment-th">Cancel Appointment</th>
        </tr>
        ...
        <td class="appointment-td text-center"> <a href="{{url('cancel_appointment',$appoints->id)}}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete your appointment?') ">Cancel</a></td>
         {{-- <td>Date</td>
        // <td>Message</td>
        // <td>Status</td> --}}
        </tr>
